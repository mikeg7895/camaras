        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePath = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FilterType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessedFrames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessedFrames_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedFrames_VideoId",
                table: "ProcessedFrames",
                column: "VideoId");
